...
async function addContact(contact) {
  ...
  let d = await call('antmed_crm.fcrm.doctype.crm_deal.crm_deal.add_contact', {
    deal: props.dealId,
    contact,
  })
  if (d) {
...
async function removeContact(contact) {
  let d = await call('antmed_crm.fcrm.doctype.crm_deal.crm_deal.remove_contact', {
    deal: props.dealId,
    contact,
  })
  if (d) {
...
async function setPrimaryContact(contact) {
  let d = await call('antmed_crm.fcrm.doctype.crm_deal.crm_deal.set_primary_contact', {
    deal: props.dealId,
    contact,
  })
  if (d) {
...
const dealContacts = createResource({
  url: 'antmed_crm.fcrm.doctype.crm_deal.api.get_deal_contacts',
