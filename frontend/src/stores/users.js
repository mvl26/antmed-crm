...
import { isAntmedUser as readAntmedBootFlag } from '@/utils/antmed'
...
export const usersStore = defineStore('crm-users', () => {
  ...
  // [W0-2 / DEC-B] Cờ AntMed đọc từ BOOT (single-source ở BE), KHÔNG hardcode tên Role ở FE.
  // Dùng để mở route /antmed/* cho user AntMed-thuần (xem router guard).
  const isAntmedUser = () => readAntmedBootFlag()
