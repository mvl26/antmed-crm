...
from antmed_crm.api.exchange_rate import (
...
class TestFetchFromFrankfurter(FrappeTestCase):
	@patch("antmed_crm.api.exchange_rate.requests.get")
	...
	@patch(
		"antmed_crm.api.exchange_rate.requests.get",
...
class TestGetExchangeRate(FrappeTestCase):
	...
	@patch("antmed_crm.api.exchange_rate._fetch_exchange_rate")
