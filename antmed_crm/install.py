...
from antmed_crm.fcrm.doctype.crm_dashboard.crm_dashboard import create_default_manager_dashboard
from antmed_crm.fcrm.doctype.crm_products.crm_products import create_product_details_script
...
def add_default_scripts():
	from antmed_crm.fcrm.doctype.fcrm_settings.fcrm_settings import create_forecasting_script
