...
def check_app_permission():
	...
	# [W0-2 ADDITIVE — DEC-B] OR-thêm nhánh AntMed: user role AntMed thuần
	# (NV kinh doanh / Thủ kho / Quản lý) cũng được serve SPA HTML.
	# KHÔNG sửa nhánh CRM trên, KHÔNG đổi check module 'FCRM'.
