...
def create_demo_data(_args: dict | None = None):
	...
	from antmed_crm.demo.activities import create_demo_activities
	from antmed_crm.demo.call_logs import create_demo_call_logs
	from antmed_crm.demo.deals import create_demo_deals
	from antmed_crm.demo.leads import create_demo_leads
	from antmed_crm.demo.notes import create_demo_notes
	from antmed_crm.demo.tasks import create_demo_tasks
	from antmed_crm.demo.users import create_demo_users
	...
	from antmed_crm.demo.leads import rebackdate_demo_leads
...
def clear_demo_data():
	...
	from antmed_crm.demo.activities import delete_demo_activities
	from antmed_crm.demo.call_logs import delete_demo_call_logs
	from antmed_crm.demo.deals import delete_demo_deals
	from antmed_crm.demo.leads import delete_demo_leads
	from antmed_crm.demo.notes import delete_demo_notes
	from antmed_crm.demo.tasks import delete_demo_tasks
	from antmed_crm.demo.users import DEMO_USER_EMAILS, delete_demo_users
