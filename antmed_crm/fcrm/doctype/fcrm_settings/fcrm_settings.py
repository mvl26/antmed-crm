...
from antmed_crm.demo.api import create_demo_data
from antmed_crm.install import after_install
...
class FCRMSettings(Document):
	...
	if TYPE_CHECKING:
		...
		from antmed_crm.fcrm.doctype.crm_dropdown_item.crm_dropdown_item import CRMDropdownItem
